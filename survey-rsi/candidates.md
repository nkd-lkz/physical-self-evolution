...
以下26项均已打开原始arXiv摘要；未把摘要中的定量主张当作已完成实验核查。优先级是调研判断，不是论文质量排名。
...
| [MEMOBench: A Process Level Memory Benchmark for Robotic Manipulation](https://arxiv.org/abs/2609.07047) | 优先 | 记忆存储/更新/压缩的过程指标；查检查点与最终成功的对应关系。 |
