...
## 2026-09-25：经验编译与响应校准

| 工作 / 观点 | 可借鉴机制 | 证据边界 |
|---|---|---|
| [Knowin GLOW](../notes/knowin-glow.md) | 执行回执、经验编译、上下文记忆 | 企业技术报告；未复现，整系统成绩不分离模块作用 |
| [Real2sim2real——具身的 scaling 起点](real2sim2real-scaling-perspective.md) | 场景自动化、交互响应校准与离线研究 harness | 用户提供观点截图，原文待核实；不是已验证新论文 |

[最小实验提案](glow-real2sim2real-experiments.md)把两者落到同容量后果监督、同预算记忆检索、响应校准。保持知识库层与项目事实分离。
